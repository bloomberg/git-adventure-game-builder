...
Since `git-adventure` is distributed under the terms of the [Apache Version 2 license](LICENSE), contributions that you make
...
The [README](README.md) contains the project documentation. If your need more or different information, please create an [Issue](../../issues).
